package com.yoyi.gatewayserver.config;
...
import com.yoyi.gatewayserver.entity.FilterEntity;
import com.yoyi.gatewayserver.entity.PredicateEntity;
            ...
            public void receiveConfigInfo(String configInfo) {
                ...
                if (refreshGatewayRoute) {
                    List<RouteEntity> list =
                            JSON.parseArray(JSONObject.parseObject(configInfo).getString("routeList")).toJavaList(RouteEntity.class);
